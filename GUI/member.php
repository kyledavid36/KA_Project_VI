...
<body>
  ...
  <script>
    ...
    document.getElementById('floorInput').addEventListener('keydown', function(event) {
      // Check if the pressed key is Enter (key code 13)
      if (event.keyCode === 13) {
        // Prevent the default action (e.g., form submission if it were in a form)
        event.preventDefault(); 
        // Call the goToFloor function
        goToFloor();
      }
    });
  </script>
